          ...
          <div class="page-title__outer">
            <div class="page-title__inner">
              <div class="page-title__holder">
                ...
                <p class="page-title__subtitle lead">Here are some of the awesome Voyager features you'll enjoy <img src="/img/emoji-victory.png" class="emoji emoji-24"></p>
              </div>              
            </div>
          </div>          
          ...
          <div class="row row-60 items-grid">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">              
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--blue text-center feature-img" style="background-image:url('/img/features-media-manager.png')">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--turquoise text-center feature-img" style="background-image:url('/img/features-menu-builder.png')">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--orange text-center feature-img" style="background-image:url('/img/features-database-builder.png')">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--violet text-center feature-img" style="background-image:url('/img/features-bread-builder.png')">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--green text-center feature-img" style="background-image:url('/img/features-settings.png')">
            ...
            <div class="col-md-4 col-xs-6 col-xxs-12">
              <a href="#_" class="box-shadow">
                <div class="feature-1__icon-holder feature-1__icon-holder--pink text-center feature-img" style="background-image:url('/img/features-compass.png')">
                  <i class="ui-book feature-1__icon"></i>
                </div>
                <div class="feature-1__base">
                  <h3 class="feature-1__title">Compass</h3>
                  <p class="feature-1__paragraph">The new compass section will help you with Voyager resources. This section also has a tab where you can execute Laravel commands and another tab to view your application log files! Yep, you can view your log files directly in Voyager! Only one word to describe how cool that is. Kickass <img src="/img/emoji-rocker.png" class="emoji emoji-16"></p>
                </div>
              </a>
            </div> <!-- end col -->
