@extends('_layouts.master', ['lighthouse' => true])
...
@section('body')
	...
	<div class="content-wrapper oh">
      ...
      <!-- Page Title -->
      <section class="page-title bottom-divider text-center" style="background:url('/assets/images/repeating-bg.png')">
        <div class="container">

          <div class="page-title__outer">
            <div class="page-title__inner">
              <div class="page-title__holder">
                <h1 class="page-title__title" style="text-align: center; margin-bottom: 25px;">Lighthouse</h1>
                <img src="/assets/images/lighthouse.png" style="max-height: 200px; margin: 0px auto; display: block;">
                <p class="page-title__subtitle lead" style="text-align:center; margin-top:20px;">The lighthouse is a showcase of applications built using Laravel Voyager <img src="/assets/images/emoji-victory.png" class="emoji emoji-24"></p>
                <p>You can learn more about how to use Laravel Voyager by using and inspecting the code from the projects built below.</p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
               <a href="https://devdojo.com/scripts/php/geekshop" class="box-shadow" target="_blank" style="cursor:pointer;">
                ...
                <div class="feature-1__base">
                  ...
                  <p class="feature-1__paragraph">Create your own Viral Geek Shop Website with this script. You can create a site like thisiswhyimbroke.com and other popular product affiliate sites. Geekshop is built with Laravel and Voyager.</p>
                </div>
              </a>
            </div>
            ...
            <div class="col-md-6">
               <a href="https://devdojo.com/scripts/php/pixel" class="box-shadow" target="_blank" style="cursor:pointer;">
                ...
                <div class="feature-1__base">
                  ...
                  <p class="feature-1__paragraph">Using Pixel you can create your own download script where users can download PSD’s, Zip files, and any other kind of graphic file from your site. Pixel was built on top of Laravel 5.4 and Voyager.</p>
                </div>
              </a>
            </div>
